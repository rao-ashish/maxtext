...
Run with: `python scripts/sweeps/run_sweeps.py`
"""
...
from scripts.sweeps.sweep_configs import ExperimentConfig, EXPERIMENTS
...
def _configure_worker_logging() -> None:
    """Ensures INFO-level logs are emitted in worker processes."""
