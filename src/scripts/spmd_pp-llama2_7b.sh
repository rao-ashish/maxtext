...
PROFILE_CMD=""
# PROFILE_CMD="nsys profile --output scripts/outputs/profiles/mmpp-spmd-mifc_256-num_repeats_1.nsys-rep --cpuctxsw=none --trace=cublas,cuda,cudnn,cusolver,nvtx,osrt,python-gil --force-overwrite true --capture-range=cudaProfilerApi --capture-range-end=stop --cuda-graph-trace=node --python-sampling=true"
